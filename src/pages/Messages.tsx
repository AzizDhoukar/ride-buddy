...
const mockChats = [
  { id: "1", name: "Ahmed K.", initials: "AK", lastMessage: "I'm at the pickup point", time: "2:32 PM", unread: 1 },
  { id: "2", name: "Maria L.", initials: "ML", lastMessage: "Thank you for the ride!", time: "Yesterday", unread: 0 },
  { id: "3", name: "Sarah J.", initials: "SJ", lastMessage: "On my way!", time: "Yesterday", unread: 0 },
];
      ...
      <div className="safe-top px-6 pt-6">
        ...
        {mockChats.length > 0 ? (
          ...
          <div className="flex flex-col items-center py-20 text-center">
            ...
            <p className="mt-1 text-sm text-muted-foreground/70">Chat will appear here during active rides</p>
          </div>
        )}
      </div>
      <BottomNav />
